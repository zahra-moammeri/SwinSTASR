...
class RSTB(nn.Module):
    ...
    def __init__(self,
        ...
        # elif resi_connection == 'wavelet':
        #     self.conv = waveletblock(dim)
        
        # elif resi_connection == 'waveletattention':
        #     self.conv = WaveletAttention(dim)

        elif resi_connection == 'transformattention':
            self.conv = AttentionBlock(dim)

        # elif resi_connection == 'wavelet_gap':
        #     self.conv = WaveletGap(dim)
